...
class SafeVideoBackground extends StatefulWidget {
  ...
  @override
  State<SafeVideoBackground> createState() => _SafeVideoBackgroundState();
}

class _SafeVideoBackgroundState extends State<SafeVideoBackground> {
